...
const ChatProvider = ({ children })=>{
        ...
        "ChatProvider.useEffect": ()=>{
            if (user) {
                ...
                newSocket.on('message_notification', {
                    "ChatProvider.useEffect": ()=>{
                        setUnreadCount({
                            "ChatProvider.useEffect": (prev)=>prev + 1
                        }["ChatProvider.useEffect"]);
                    }
                }["ChatProvider.useEffect"]);
                return ({
    ...
    const markConversationAsRead = async (conversationId)=>{
        try {
            if (!user) return;
            await chatApi.post(`/conversations/${conversationId}/read`, {
                userId: user._id
            });
...
_s(ChatProvider, "sWYmuuYswpaUhdFdht+daoZjve0=", false, function() {
    return [
        __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$context$2f$AuthContext$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useAuth"]
    ];
});
...
//# sourceMappingURL=src_context_a91c404b._.js.map